...
[inv](#invm)
[isprime](#isprimen)
[laguerre](#laguerrexna)
[lcm](#lcmab)
[legendre](#legendrexnm)
[log](#logx)
[mod](#modab)
[outer](#outerab)
[prime](#primen)
...
[Eigenmath (archive/wayback)](https://web.archive.org/web/20110518233607/http://sourceforge.net:80/projects/eigenmath/)

[Wikipedia/french](https://fr.wikipedia.org/wiki/Eigenmath_(moteur_de_calcul))

The C version of Eigenmath used here (core) is copyrighted (GPL v2):

Copyright (C) 2004 by George Weigt
